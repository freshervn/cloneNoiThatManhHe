    ...
    return (          
        <nav className='d-flex justify-content-between nav-index px-1'>                        
            <ul className='nav-links py-2'>
                <li className={'link hv-btn-white' + (active =='Home' ? 'active' : '') } onClick={()=>Changestab('Home')}>
                ...
                <li className={'link hv-btn-white' + (active =='fbtv' ? 'active' : '') } onClick={()=>Changestab('fbtv')}>
                    <Link to='/' replace='false'>                            
                ...
                <li className={'link hv-btn-white' + (active =='datcv' ? 'active' : '') } onClick={()=>Changestab('datcv')}>
                    <Link to='/' replace='false'>                            
                        <img src={require('../images/icons/topcv.ico').default} alt=""/>                        
                    </Link>
                </li>        
                <li className={'link hv-btn-white' + (active =='notification' ? 'active' : '') } onClick={()=>Changestab('notification')}>
                    <Link to='/' replace='false'>                                                    
                ...
                <li className={'link hv-btn-white' + (active =='gaming' ? 'active' : '') } onClick={()=>Changestab('gaming')}>
                    <Link to='/' replace='false'>                                                    
                        <svg viewBox="0 0 28 28" class="a8c37x1j ms05siws hwsy1cff b7h9ocf4 em6zcovv" height="28" width="28">
                ...
                <li className={'link hv-btn-white' + (active =='menu' ? 'active' : '') } onClick={()=>Changestab('menu')}>
