...
function Navbarmobie() {
    ...
    return (          
        <nav className='d-flex justify-content-between nav-index px-1'>                        
            <ul className='nav-links py-2'>
                <li className={'link hv-lg-btn-white' + (active ==='Home' ? ' active' : '') } onClick={()=>Changestab('Home')}>
                    <Link to='/'>                            
                ...
                <li className={'link hv-lg-btn-white' + (active ==='fbtv' ? ' active' : '') } onClick={()=>Changestab('fbtv')}>
                    <Link to='/'>                            
                    <svg viewBox="0 0 28 28" className="a8c37x1j ms05siws hwsy1cff b7h9ocf4 em6zcovv" height="28" width="28">
                    ...
                    <span className='notification on'>5+</span>
                    </Link>
                </li>               
                <li className={'link hv-lg-btn-white' + (active ==='datcv' ? ' active' : '') } onClick={()=>Changestab('datcv')}>
                    <Link to='/'>                            
                        <img src={require('../images/icons/topcv.ico').default} alt=""/>                        
                    </Link>
                </li>        
                <li className={'link hv-lg-btn-white' + (active ==='notification' ? ' active' : '') } onClick={()=>Changestab('notification')}>
                    <Link to='/'>                                                    
                ...
                <li className={'link hv-lg-btn-white' + (active ==='gaming' ? ' active' : '') } onClick={()=>Changestab('gaming')}>
                    <Link to='/'>                                                    
                        <svg viewBox="0 0 28 28" className="a8c37x1j ms05siws hwsy1cff b7h9ocf4 em6zcovv" height="28" width="28">
                ...
                <li className={'link hv-lg-btn-white' + (active ==='menu' ? ' active' : '') } onClick={()=>Changestab('menu')}>
                    <Link to='/about'>                                                          
                        <i className='facebookCatalog my-auto'></i>
                    </Link>
                </li>
