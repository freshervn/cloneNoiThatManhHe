                    ...
                    <header>
                        ...
                        <nav className='d-lg-flex flex-wrap py-lg-1 px-lg-5 px-3'>                            
                            ...
                            <div className='d-none d-lg-flex justify-content-between  flex-wrap mr-auto size-15'>
                                <Link to='#' className='btn py-2 px-3 flex-auto mr-lg-2 hv-btn-white text-secondary'> 
                                    <b className=''>
                                        Bài viết
                                    </b>
                                </Link>            
                                ...
                                <div className="btn-group">
                                    <button type="button" className="btn py-2 px-3 hv-btn-white text-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <b>
                                            Xem thêm
                                        </b>
                                    </button>
                                    <div className="dropdown-menu p-2 rounded">
                                        <Link className="dropdown-item rouned p-2" to="#">Check in</Link>
                                        <Link className="dropdown-item rouned p-2" to="#">Thể thao</Link>
                                        <Link className="dropdown-item rouned p-2" to="#">Âm nhạc</Link>
                                        <Link className="dropdown-item rouned p-2" to="#">Phim</Link>
                                        <Link className="dropdown-item rouned p-2" to="#">Sách</Link>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className='bg-white rounded-lg-1 shadow p-lg-3 mb-3'>
                                        ...
                                        <div className='d-flex'>
                                            <button className='w-100 btn size-14 d-lg-none'>
                                                <img className="mr-1" src="https://static.xx.fbcdn.net/rsrc.php/v3/yW/r/OR6SzrfoMFg.png" alt="" height="14" width="14"></img>
